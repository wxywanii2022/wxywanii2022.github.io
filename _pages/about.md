...
* **Post-training of Foundation Large Language Models** with [Prof. Shaojiang Wang](https://openreview.net/profile?id=~Shaojiang_Wang2) at the [Institute of Industrial Artificial Intelligence, Chinese Academy of Sciences](http://iaii.cas.cn/).
* **Tool-Augmented Reasoning for Multimodal Large Language Models** with [Prof. Yufeng Li](http://www.lamda.nju.edu.cn/liyf/) at the [LAMDA Group, Nanjing University](https://www.lamda.nju.edu.cn/MainPage.ashx).
...
Outside of research, I am originally from **Nanjing, China**, and graduated from **Nanjing Foreign Language School**. In my free time, I enjoy working out, playing basketball and tennis, listening to music, and occasionally playing League of Legends and Call of Duty.
